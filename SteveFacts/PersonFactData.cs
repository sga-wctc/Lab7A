...
namespace SteveFacts
{
    class PersonFactData
    {
        ...
        static PersonFactData()
        {
            ...
            all.Add(new PersonFactData() { TheFact = "I will eat bananas on occassion", 
                ShortFact = "Banana?",
                ImageFile = "Banana.jpg" });
            all.Add(new PersonFactData() { TheFact = "I prefer Green Beans", 
                ShortFact = "Lagumes/Beans?",
                ImageFile = "Legumes.jpg"  });
            all.Add(new PersonFactData() { TheFact = "I prefer marina sauce with spagetti", 
                ShortFact = "Tomatos?",
                ImageFile = "tomato.png"   });
            all.Add(new PersonFactData() { TheFact = "I enjoy most vegetables", 
                ShortFact = "Vegatables?",
                ImageFile = "Vegetables.jpg"   });
            all.Add(new PersonFactData() { TheFact = "Is zucchini really a vegetable?", 
                ShortFact = "Zucchini?",
